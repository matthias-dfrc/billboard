...
request_Overview.onload = function () {
    ...
    var todayNum = data[7].visitorsNumber;
    var todayAvgNum = data[7].expectedVisitorsNumber;
...
request_DailyNumbers.onload = function () {
    ...
    var monthlyNum = data[7].thisMonthVisitorsNumber;
    ...
    var yearlyNum = data[7].thisYearVisitorsNumber
    var div = document.createElement('div');
